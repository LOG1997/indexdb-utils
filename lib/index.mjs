function oi(oe, le, W, A) {
  function ce(M) {
    return M instanceof W ? M : new W(function(Y) {
      Y(M);
    });
  }
  return new (W || (W = Promise))(function(M, Y) {
    function z(he) {
      try {
        B(A.next(he));
      } catch (J) {
    ...
    function B(he) {
      he.done ? M(he.value) : ce(he.value).then(z, te);
    }
    B((A = A.apply(oe, le || [])).next());
  });
}
function ai(oe, le) {
  var W = { label: 0, sent: function() {
    if (M[0] & 1) throw M[1];
    return M[1];
  }, trys: [], ops: [] }, A, ce, M, Y = Object.create((typeof Iterator == "function" ? Iterator : Object).prototype);
  return Y.next = z(0), Y.throw = z(1), Y.return = z(2), typeof Symbol == "function" && (Y[Symbol.iterator] = function() {
    return this;
  }), Y;
  function z(B) {
    return function(he) {
  ...
  function te(B) {
    ...
    for (; Y && (Y = 0, B[0] && (W = 0)), W; ) try {
      if (A = 1, ce && (M = B[0] & 2 ? ce.return : B[0] ? ce.throw || ((M = ce.return) && M.call(ce), 0) : ce.next) && !(M = M.call(ce, B[1])).done) return M;
      switch (ce = 0, M && (B = [B[0] & 2, M.value]), B[0]) {
        case 0:
        case 1:
          M = B;
          break;
...
(function(oe, le) {
  (function(W, A) {
    ...
    var M = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : Ut, Y = Object.keys, z = Array.isArray;
    function te(e, n) {
      return typeof n != "object" || Y(n).forEach(function(t) {
        e[t] = n[t];
      }), e;
    }
    ...
    function Be(e, n) {
      typeof n == "function" && (n = n(B(e))), (typeof Reflect > "u" ? Y : Reflect.ownKeys)(n).forEach(function(t) {
        _e(e, t, n[t]);
      });
    }
    ...
    var Fe = "BigUint64Array,BigInt64Array,Array,Boolean,String,Date,RegExp,Blob,File,FileList,FileSystemFileHandle,FileSystemDirectoryHandle,ArrayBuffer,DataView,Uint8ClampedArray,ImageBitmap,ImageData,Map,Set,CryptoKey".split(",").concat(ae([8, 16, 32, 64].map(function(e) {
...
`);
 ...
 ` + o : ""), this.inner = o || null) : typeof i == "object" && (this.message = "".concat(i.name, " ").concat(i.message), this.inner = i) : (this.message = ie[n] || t, this.inner = null);
    ...
    var ue = K.reject, tn = "￿", Re = "Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.", Jt = "String expected.", yn = [], Nn = "__dbnames", vt = "readonly", mt = "readwrite";
    function rn(e, n) {
      return e ? n ? function() {
    ...
    var rr = (ne.prototype._trans = function(e, n, t) {
      ...
      try {
        var f = r && r.db._novip === this.db._novip ? r === T.trans ? r._promise(e, a, t) : Ye(function() {
          ...
          if (p._state.openComplete) return ue(new C.DatabaseClosed(p._state.dbOpenError));
          if (!p._state.isBeingOpened) {
            if (!p._state.autoOpen) return ue(new C.DatabaseClosed());
            p.open().catch(H);
          }
      ...
      var t = this;
      return e && e.constructor === Object ? this.where(e).first(n) : e == null ? ue(new C.Type("Invalid argument to Table.get()")) : this._trans("readonly", function(r) {
      ...
      (this.schema.mappedClass = e).prototype instanceof er && (function(f, c) {
        ...
        W(f, c), f.prototype = c === null ? Object.create(c) : (p.prototype = c.prototype, new p());
      ...
      return typeof e != "object" || z(e) ? this.where(":id").equals(e).modify(n) : (e = ye(e, this.schema.primKey.keyPath), e === void 0 ? ue(new C.InvalidArgument("Given object does not contain its primary key")) : this.where(":id").equals(e).modify(n));
    ...
    var Fe = Symbol(), Pn = (ar.prototype.execute = function(e) {
      if (this.add !== void 0) {
        var n = this.add;
        if (z(n)) return ce(ce([], z(e) ? e : [], !0), n).sort();
    ...
    var Rr = (Q.prototype._read = function(e, n) {
      var t = this._ctx;
      return t.error ? t.table._trans(null, ue.bind(null, t.error)) : t.table._trans("readonly", e).then(n);
      ...
      return this._write(function(r) {
        var i, o, a;
        a = typeof e == "function" ? e : (i = Y(e), o = i.length, function(h) {
        ...
        function u(h, g) {
          ...
          d += h - g;
          for (var w = 0, x = Y(b); w < x.length; w++) {
            var S = x[w];
            l.push(b[S]);
          }
        }
        ...
        return n.clone().primaryKeys().then(function(h) {
          function m(g) {
            ...
            return f.getMany({ trans: r, keys: h.slice(g, g + w), cache: "immutable" }).then(function(x) {
              ...
              return Promise.resolve(0 < S.length && f.mutate({ trans: r, type: "add", values: S }).then(function(V) {
                for (var L in V.failures) P.splice(parseInt(L), 1);
                u(S.length, V);
              })).then(function() {
                return (0 < k.length || b && typeof e == "object") && f.mutate({ trans: r, type: "put", keys: O, values: k, criteria: b, changeSpec: typeof e != "function" && e, isAdditionalChunk: 0 < g }).then(function(V) {
                  return u(k.length, V);
                });
              }).then(function() {
                return (0 < P.length || b && e === wt) && f.mutate({ trans: r, type: "delete", keys: P, criteria: b, isAdditionalChunk: 0 < g }).then(function(V) {
                  return u(P.length, V);
                });
              }).then(function() {
      ...
      return e._addAlgorithm(function(d, v, h) {
        ...
        for (var g = null, w = l; w < s; ++w) {
          var x = function(S, k, O, P, _, F) {
            for (var N = Math.min(S.length, P.length), V = -1, L = 0; L < N; ++L) {
              var je = k[L];
              if (je !== P[L]) return _(S[L], O[L]) < 0 ? S.substr(0, L) + O[L] + O.substr(L + 1) : _(S[L], P[L]) < 0 ? S.substr(0, L) + P[L] + O.substr(L + 1) : 0 <= V ? S.substr(0, V) + k[V] + O.substr(V + 1) : null;
              _(S[L], je) < 0 && (V = L);
            }
            return N < P.length && F === "next" ? S + O.substr(S.length) : N < S.length && F === "prev" ? S.substr(0, O.length) : V < 0 ? null : S.substr(0, V) + P[V] + O.substr(V + 1);
          }(m, b, u[w], f[w], a, c);
    ...
    var En = "storagemutated", _t = "x-storagemutated-1", He = On(null, En), Lr = (qe.prototype._lock = function() {
      ...
      var r = this;
      if (e === "readwrite" && this.mode !== "readwrite") return ue(new C.ReadOnly("Transaction is readonly"));
      if (!this.active) return ue(new C.TransactionInactive());
      ...
      function i(y) {
        ...
        return { name: d, schema: y, mutate: function(v) {
          ...
          return new Promise(function(x, S) {
            ...
            var V = [], L = [], je = 0;
            if (m === "deleteRange") {
              if (w.type === 4) return x({ numFailures: je, failures: L, results: [], lastResult: void 0 });
              w.type === 3 ? V.push(_ = k.clear()) : V.push(_ = k.delete(r(w)));
            } else {
              var O = P ? O ? [g, b] : [g, null] : [b, null], U = O[0], ge = O[1];
              if (P) for (var we = 0; we < F; ++we) V.push(_ = ge && ge[we] !== void 0 ? k[m](U[we], ge[we]) : k[m](U[we])), _.onerror = N;
              else for (we = 0; we < F; ++we) V.push(_ = k[m](U[we])), _.onerror = N;
            }
            function it(ke) {
              ke = ke.target.result, V.forEach(function(un, Lt) {
                return un.error != null && (L[Lt] = un.error);
              }), x({ numFailures: je, failures: L, results: m === "delete" ? b : V.map(function(un) {
                return un.result;
              }), lastResult: ke });
            }
          ...
          return new Promise(function(b, g) {
            b = re(b);
            for (var w, x = h.objectStore(d), S = m.length, k = new Array(S), O = 0, P = 0, _ = function(V) {
              V = V.target, k[V._pos] = V.result, ++P === O && b(k);
          ...
          return new Promise(function(x, S) {
            ...
            _.onerror = Ie(S), _.onsuccess = re(function(F) {
              var N, V, L, je, U = _.result;
              U ? (U.___id = ++Ur, U.done = !1, N = U.continue.bind(U), V = (V = U.continuePrimaryKey) && V.bind(U), L = U.advance.bind(U), je = function() {
                throw new Error("Cursor not stopped");
              }, U.trans = h, U.stop = U.continue = U.continuePrimaryKey = U.advance = function() {
                throw new Error("Cursor not started");
              }, U.fail = re(S), U.next = function() {
                var ge = this, we = 1;
                ...
                var it = new Promise(function(ke, un) {
                  ke = re(ke), _.onerror = Ie(un), U.fail = un, U.stop = function(Lt) {
                    U.stop = U.continue = U.continuePrimaryKey = U.advance = je, ke(Lt);
                  };
                });
                return _.onsuccess = re(function(ke) {
                  _.onsuccess = we, we();
                }), U.continue = N, U.continuePrimaryKey = V, U.advance = L, we(), it;
              }, x(U)) : x(null);
            }, S);
          });
        }, count: function(v) {
    ...
    function zr(e, n, t, r) {
      ...
      Ye(function() {
        return T.trans = o, T.transless = u, n !== 0 ? (Wn(e, t), c = n, ((f = o).storeNames.includes("$meta") ? f.table("$meta").get("version").then(function(p) {
            ...
            v.push(function() {
              ...
              if (x && m._cfg.version > y) {
                ...
                w.del.forEach(function(P) {
                  S[P] = b[P];
                }), St(s, [s.Transaction.prototype]), zn(s, [s.Transaction.prototype], Y(S), S), l.schema = S;
                var k, O = Z(x);
          ...
          var s, y, l, d, v, h;
        }).catch(a)) : (Y(i).forEach(function(p) {
    ...
    var Gr = (Xn.prototype._parseStoresSpec = function(e, n) {
      ...
      }), n._dbSchema = i, St(n, [n._allTables, n, n.Transaction.prototype]), zn(n, [n._allTables, n, n.Transaction.prototype, this._cfg.tables], Y(i), i), n._storeNames = Y(i), this;
    ...
    function Qr(e) {
        ...
        return new K(function(y, l) {
          ...
          v.onerror = Ie(l), v.onblocked = re(e._fireOnBlocked), v.onupgradeneeded = re(function(h) {
            ...
            if (0 < S.length) try {
              ...
              if (n.autoSchema) m = x, b = k, (h = e).verno = m.version / 10, b = h._dbSchema = Gn(0, m, b), h._storeNames = sn(m.objectStoreNames, 0), zn(h, [h._allTables], Y(b), b);
      ...
      return K.race([r, (typeof navigator > "u" ? K.resolve() : !navigator.userAgentData && /Safari\//.test(navigator.userAgent) && !/Chrom(e|ium)\//.test(navigator.userAgent) && indexedDB.databases ? new Promise(function(y) {
        ...
        return r === n.openCanceller && e._close(), ue(y);
      }).finally(function() {
        n.openComplete = !0, c();
      }).then(function() {
        var y;
    ...
    function Bt(e, n, t, r) {
      return t = t || {}, r = r || "", Y(e).forEach(function(i) {
        var o, a, u;
      ...
      return A(A({}, e), { table: function(n) {
        ...
        return A(A({}, t), { mutate: function(i) {
          ...
          function p(s) {
            ...
            return (s = s.type === "add" || s.type === "put" ? A(A({}, s), { keys: h }) : A({}, s)).type !== "delete" && (s.values = ce([], s.values)), s.keys && (s.keys = ce([], s.keys)), y = t, d = h, ((l = s).type === "add" ? Promise.resolve([]) : y.getMany({ trans: l.trans, keys: d, cache: "immutable" })).then(function(m) {
      ...
      return A(A({}, e), { transaction: function(r, i, o) {
        ...
        var i = e.table(r), o = i.schema, a = o.primaryKey, s = o.indexes, u = a.extractKey, f = a.outbound, c = a.autoIncrement && s.filter(function(l) {
          ...
          return z(k) ? (w.addKeys(k), (P = S === "delete" || k.length === O.length ? mr(k, P) : null) || x.addKeys(k), (P || O) && (v = d, h = P, m = O, o.indexes.forEach(function(_) {
            var F = v(_.name || "");
            function N(L) {
              return L != null ? _.extractKey(L) : null;
            }
            function V(L) {
              return _.multiEntry && z(L) ? L.forEach(function(je) {
                return F.addKey(je);
              }) : F.addKey(L);
            }
            (h || m).forEach(function(L, ge) {
              var U = h && N(h[ge]), ge = m && N(m[ge]);
              G(U, ge) !== 0 && (U != null && V(U), ge != null && V(ge));
            });
            ...
            return !k || l.type !== "add" && l.type !== "put" || (w.addKeys(_.results), c && c.forEach(function(F) {
              var N = l.values.map(function(L) {
                return F.extractKey(L);
              }), V = F.keyPath.findIndex(function(L) {
                return L === a.keyPath;
              });
              _.results.forEach(function(L) {
                return N[V] = L;
              }), d(F.name).addKeys(N);
    ...
    var Ne = (se.prototype.version = function(e) {
      ...
      var e = this;
      return Y(this._allTables).map(function(n) {
      ...
      var e = (function(n, t, r) {
        ...
        return r = o.pop(), [n, ae(o), r];
      }).apply(this, arguments);
      return this._transaction.apply(this, e);
    }, se.prototype._transaction = function(e, n, t) {
      ...
      var f = (function c(p, s, y, l, d) {
        return K.resolve().then(function() {
          ...
          return b && pn(), v = K.follow(function() {
            ...
            return h.active ? g : ue(new C.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"));
          }) : v.then(function() {
            return m;
          })).then(function(g) {
    ...
    function se(e, n) {
      ...
      this._options = n = A({ addons: se.addons, autoOpen: !0, indexedDB: r.indexedDB, IDBKeyRange: r.IDBKeyRange, cache: "cloned" }, n), this._deps = { indexedDB: n.indexedDB, IDBKeyRange: n.IDBKeyRange }, r = n.addons, this._dbSchema = {}, this._versions = [], this._storeNames = [], this._allTables = {}, this.idbdb = null, this._novip = this;
...
(function(oe, le) {
  (function(W, A) {
    ...
    var W = 1e3, A = 6e4, ce = 36e5, M = "millisecond", Y = "second", z = "minute", te = "hour", B = "day", he = "week", J = "month", Be = "quarter", Ee = "year", _e = "date", $e = "Invalid Date", ot = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, at = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, sn = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(R) {
      ...
      return { M: J, y: Ee, w: he, d: B, D: _e, h: te, m: z, s: Y, ms: M, Q: Be }[R] || String(R || "").toLowerCase().replace(/s$/, "");
    }, u: function(R) {
      return R === void 0;
    } }, Le = "en", ye = {};
    ye[Le] = sn;
    ...
    X.l = fn, X.i = ln, X.w = function(R, j) {
      return ae(R, { locale: j.$L, utc: j.$u, x: j.$x, $offset: j.$offset });
    };
    var Ae = function() {
      function R(D) {
      ...
      return j.parse = function(D) {
        ...
        return ae(D) < this.startOf(I);
      }, j.isBefore = function(D, I) {
        return this.endOf(I) < ae(D);
      }, j.$g = function(D, I, E) {
        ...
        var E, $ = X.p(D), q = "set" + (this.$u ? "UTC" : ""), Z = (E = {}, E[B] = q + "Date", E[_e] = q + "Date", E[J] = q + "Month", E[Ee] = q + "FullYear", E[te] = q + "Hours", E[z] = q + "Minutes", E[Y] = q + "Seconds", E[M] = q + "Milliseconds", E)[$], ie = $ === B ? this.$D + (I - this.$W) : I;
        if ($ === J || $ === Ee) {
        ...
        if (q === B) return Z(1);
        if (q === he) return Z(7);
        var ie = (E = {}, E[z] = A, E[te] = ce, E[Y] = W, E)[q] || 1, ee = this.$d.getTime() + D * ie;
        return X.w(ee, this);
        ...
        var $, q = this, Z = X.p(I), ie = ae(D), ee = (ie.utcOffset() - this.utcOffset()) * A, fe = this - ie, ve = function() {
          return X.m(q, ie);
        };
        switch (Z) {
          case Ee:
    ...
    return ae.prototype = Ce, [["$ms", M], ["$s", Y], ["$m", z], ["$H", te], ["$W", B], ["$M", J], ["$y", Ee], ["$D", _e]].forEach(function(R) {
      Ce[R[1]] = function(j) {
        return this.$g(j, R[0], R[1]);
      };
    }), ae.extend = function(R, j) {
      return R.$i || (R(j, Ae, ae), R.$i = !0), ae;
    }, ae.locale = fn, ae.isDayjs = ln, ae.unix = function(R) {
      return ae(1e3 * R);
    }, ae.en = ye[Le], ae.Ls = ye, ae.p = {}, ae;
  });
})(Er);
var si = Er.exports;
...
var li = (
  ...
  function() {
    function oe(le, W, A) {
      W === void 0 && (W = 1), A === void 0 && (A = []), this.name = le, this.version = W, this.dbKeys = A, this.dbStore = new Vt(le), this.dbStore.version(this.version).stores({
        dbData: "++id,dateTime,type"
        // Primary key & Indexed props
      });
    }
    return oe.prototype.setData = function(le) {
      le.dateTime || (le.dateTime = ci().format("YYYY-MM-DD HH:mm:ss:SSS")), le.type || (le.type = "info"), this.dbStore.dbData.add(le);
    }, oe.prototype.deleteAll = function() {
      return this.dbStore.dbData.clear();
    }, oe.prototype.getAllData = function() {
      return oi(this, void 0, void 0, function() {
        return ai(this, function(le) {
          switch (le.label) {
            case 0:
              return [4, this.dbStore.dbData.toArray()];
            case 1:
              return [2, le.sent()];
          }
        });
      });
    }, oe.prototype.getAllLength = function() {
      return this.dbStore.dbData.count();
    }, oe.prototype.getFilterData = function(le) {
      return this.dbStore.dbData.filter(function(W) {
        return W.content.includes(le);
      }).toArray();
